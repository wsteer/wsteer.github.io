...
$(document).ready(function() {
  $('.about-content .card .cardImg').hide();
    if (isPhoneDevice) {
        //mobile
    } else {
        //desktop
    ...
    $('.about-content .cardHover').click(function(){
      $('> .cardImg',this).show();
    });
    $('.about-content .cardHover span').click(function(e){
      e.stopPropagation();
      $('.about-content .cardHover .cardImg').hide();
          });

    //   $('.mtp-content .mtp-close').click(function(e){
    //     e.stopPropagation();
    //     $('.mtp-content').hide();
    //
    // });
